 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Harrison Galloway");
		  toPrint += p1.toString("hgalloway3");
		  //Person2 replace P2 with your name
		  //and gburdell2 with your gt id
		  Person2 p2 = new Person2("Michael Falk");
		  toPrint += p2.toString("mfalk6");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Amier Naji");
		  toPrint += p3.toString("anaji3");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Richard Hernandez");
          toPrint += p4.toString("rhernandez35");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Cody Berry");
          toPrint += p5.toString("jberry35");
